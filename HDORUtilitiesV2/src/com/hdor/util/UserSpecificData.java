...
public class UserSpecificData {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String eventId = "6684ff756ff9361402cfe3f0"; // Update with your actual event ID
        String fitId="396170";
        ...
        while (lastIndex <= totalSize) {
            ...
            JSONObject response = getDataFromLeaderBoardAPI(eventId,fitId, countPerPage, lastIndex);
            if (response != null) {
                // Process the response
                processLeaderBoardResponseJson(response, eventId,fitId);
     ...
     */
    public static void processLeaderBoardResponseJson(JSONObject response, String eventId, String fitId) throws Exception {
        ...
        for (int i = 0; i < arraySize; i++) {
            ...
            String date=resultJSON.optString("date", "N/A");
            int distance=0;
            String bestTime = "N/A";
            ...
            if (resultJSON.has("dataPoints")) {
                ...
                for (int j = 0; j < dataPoints.length(); j++) {
                    ...
                    switch (dataType) {
                        ...
                        case "distance":
                        	distance = dataPoint.optInt("value", 0);
                            break;
                        case "bestTime":
     ...
     */
    public static JSONObject getDataFromLeaderBoardAPI(String eventId,String fitId, int countPerPage, int lastIndex) {
        URL apiURL;
        ...
        try {
            ...
            String strURL = "https://apiv2.hdor.com/report/report/overall/details";
