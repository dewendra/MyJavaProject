...
public class TeamMembersReport {
	 ...
	 */
	public static JSONObject getMembersDataFromAPI(String eventId, String teamId,   int countPerPage) {
		...
		try {
			...
			String strURL = "https://apiv2.hdor.com/report/report/team/details";
